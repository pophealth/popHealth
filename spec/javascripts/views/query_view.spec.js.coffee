describe 'QueryView', ->
  beforeEach ->
    ...
    @query = new Thorax.Models.Query {measure_id: submeasure.get('id'), sub_id: submeasure.get('sub_id'), effective_date: json['users.json'][0].effective_date, effective_start_date: json['users.json'][0].effective_start_date, effective_end_date: json['users.json'][0].effective_end_date}, parent: submeasure
