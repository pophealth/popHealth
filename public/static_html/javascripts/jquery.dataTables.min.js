...
_oExt.sVersion="1.5.5";_oExt.iApiIndex=0;_oExt.oApi={};_oExt.afnFiltering=[];_oExt.aoFeatures=[];
...
var aDom=sDom;var nTmp;for(var i=0;i<aDom.length;i++){var cOption=aDom[i];if(cOption=="<"){var nNewNode=document.createElement("div");
var cNext=aDom[i+1];if(cNext=="'"||cNext=='"'){var sClass="";var j=2;while(aDom[i+j]!=cNext){sClass+=aDom[i+j];
