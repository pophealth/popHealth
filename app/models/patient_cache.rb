class PatientCache
  ...
  scope :by_provider, ->(provider, effective_start_date, effective_end_date) { where({'value.provider_performances.provider_id' => provider.id, 'value.effective_date'=>effective_date, 'value.effective_start_date'=>effective_start_date, 'value.effective_end_date'=>effective_end_date}) }
