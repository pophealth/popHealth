...
Make sure your local database server is running and create a new user *poplaika* with password *poplaika* and a new database/schema called *poplaika*. Find the database.yml.template file in laika/config under your local Laika project and edit it to include your database settings, for example:
