...
When prompted for the directory, enter the *full path* of the directory where the C32 files are located on disk, i.e. "/Users/popHealth/data/C32-files/" or "C:\data\popHealth\C32-files\" on Windows. 
